  ...
  return (
    <div className="flex links">
      ...
      <a href="https://wa.me/+917898691929" target="blank">
        <img
          className="w-10 h-10 mx-1 transition-all duration-700 ease-in-out delay-75 rounded-full hover:bg-white hover:scale-110 hover:rotate-[360deg]"
      ...
      <a href="https://github.com/ashish1seven" target="blank">
        <img
          className="w-10 h-10 ml-1 transition-all duration-700 ease-in-out delay-75 rounded-full hover:bg-white hover:scale-110 hover:rotate-[360deg]"
